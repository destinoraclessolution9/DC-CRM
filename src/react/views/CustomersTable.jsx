...
function Row({ c, meta }) {
    ...
    return (
        <tr onClick={() => app().showCustomerDetail && app().showCustomerDetail(c.id)} style={{ cursor: 'pointer' }}>
            ...
            <td data-label="Status"><span className="score-badge score-A+">{(c.status || 'active').toUpperCase()}</span></td>
            <td onClick={(e) => e.stopPropagation()}>
                <button className="btn-icon" title="Edit"><i className="fas fa-edit"></i></button>
