...
- [x] F-exclusion COMPLETE: notification bell skips grade-F (birthday badge + panel + refill scope). F is now fully dark everywhere — re-engagement, proposals, birthday dispatcher, bell, and greyed-out in the list.
