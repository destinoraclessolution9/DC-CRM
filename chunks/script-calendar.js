...
(() => {
    ...
    const _TRIGGER_DEFAULTS = {
        ...
        painting_huiji:   { trigger_category: 'after_cps', event_keywords: '汇集-商业,汇集-灵活,汇集-简易,汇聚-专案,汇集专案-Condo,汇集专案-Terrace,汇集专案-Semi-D,汇集专案-Bungalow,汇集商业-Retail,汇集商业-Factory,汇集商业-Shoplot,汇集商业-Office,汇集灵活-Condo,汇集灵活-Terrace,汇集灵活-Semi-D,汇集灵活-Bungalow,汇集简易-Condo,汇集简易-Terrace,汇集简易-Semi-D,汇集简易-Bungalow', solution_category_match: '画作', cps_interest_match: '', solution_match: '', eligibility_tiers: 'active', icon: '🖼️', template_name: '画作 → 汇集', description: '画作 proposed → any 汇集 invite (Active)', sort_order: 22, message_template: 'Hi {name}，诚邀您出席《{event_name}》！日期：{date}，地点：{venue}。— {agent_name}', delay_days: 0, event_window_days: 60 },
        // ── 风水方案 ───────────────────────────���─────────────────���────────────────────
        ...
        fs_huiji:   { trigger_category: 'after_cps', event_keywords: '汇集-商业,汇集-灵活,汇集-简易,汇聚-专案,汇集专案-Condo,汇集专案-Terrace,汇集专案-Semi-D,汇集专案-Bungalow,汇集商业-Retail,汇集商业-Factory,汇集商业-Shoplot,汇集商业-Office,汇集灵活-Condo,汇集灵活-Terrace,汇集灵活-Semi-D,汇集灵活-Bungalow,汇集简易-Condo,汇集简易-Terrace,汇集简易-Semi-D,汇集简易-Bungalow', solution_category_match: '风水方案', cps_interest_match: '', solution_match: '', eligibility_tiers: 'active', icon: '🏠', template_name: '风水方案 → 汇集', description: '风水方案 proposed → any 汇集 invite (Active)', sort_order: 33, message_template: 'Hi {name}，诚邀您出席《{event_name}》！日期：{date}，地点：{venue}。— {agent_name}', delay_days: 0, event_window_days: 60 },
    ...
    const viewActivityDetails = async (activityId) => {
        ...
        if (isAttendeeType && activity.event_id) {
            ...
            const prospectSection = `
                <div class="detail-section">
                    <h4>Attendees <span style="font-size:11px;color:#9CA3AF;font-weight:400;">(${prospectAttendees.length}${marketingEvent && marketingEvent.target_attendance != null ? ` / 目标 ${escapeHtml(String(marketingEvent.target_attendance))}` : ''})</span></h4>
