...
insert into public.schema_migrations (filename, sha256, applied_at) values
  ...
  ('ltv_purchase_backfill_2026-06-19.sql', '7e1d12755598654872395cc98a30ae8a833859098d15029484f1625442c85d83', '2026-06-19T00:00:00Z')
on conflict (filename) do nothing;

-- ---------- verify ----------
-- Expected count after backfill on a fresh ledger: 65
