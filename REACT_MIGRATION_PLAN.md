...
2. Modals/overlays/embedded/mixed (the "modals deferred" category):
   ...
   - [ ] journey (embedded detail-tab + widgets), fude (mixed dashboard — needs section-extraction rewrite), knowledge_capture/daily_notes/detail, cps-analysis, apu-appraisal, destiny-blueprint, fude-redeem, story-detail, reward-crud, highlight-crud, customer-survey.
