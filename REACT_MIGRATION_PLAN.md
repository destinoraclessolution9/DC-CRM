...
NEXT = calendar (highest-risk, deploy ALONE) → month alias → referrals (D3 tree). Then revisit reports agent-dropdown. fude/home/ai/journey/search remain deferred (modal/overlay/mixed).
